...
public class KitchenGameMultiplayer : NetworkBehaviour
{
    ...
    public void SetPlayerName(string newPlayerName)
    {
        ...
        PlayerPrefs.GetString(PLAYER_PREFS_PLAYER_NAME_MULTIPLAYER, newPlayerName);
    }
    ...
    {
        KitchenObjectSO kitchenObjectSO = GetKitchenObjectSOAtIndex(kitchenObjectSOIndex);
    ...
    public KitchenObjectSO GetKitchenObjectSOAtIndex(int kitchenObjectSOIndex)
    {
